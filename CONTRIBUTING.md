...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   message guidelines](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#commits)
   or your code is unlikely be merged into the main project. Especially, Use prefix for commit comment.
